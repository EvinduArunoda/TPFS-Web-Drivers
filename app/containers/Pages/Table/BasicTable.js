...
class BasicTable extends Component {
  ...
  render() {
    ...
    const client = {
      ...
      production: 'AaWWrMSlrSXr4mcyiJdA1rF3smBtkc0GcCN1-A2oSjaAbJ6CQ1TXLDhKEFQuhFsLl50dANZaC48dBAED',
    };
                ...
                && this.state.Ticket.map((ee, index) => (
                  <TableRow>
                    ...
                    <TableCell align="right">
                      ...
                      && (
                        <PaypalExpressBtn env={env} client={client} currency={currency} total={ee.FineAmount} onError={onError} onSuccess={this.onSuccess.bind(this, ee)} onCancel={onCancel} />
                      )
